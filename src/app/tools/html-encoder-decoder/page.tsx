...
export default function HtmlEncoderDecoderPage() {
  const [input, setInput] = useState('<div class="container">Hello VelnoxLabs!</div>');
    ...
    '@graph': [
      {
        ...
        'name': 'VelnoxLabs HTML Encoder & Decoder',
        'operatingSystem': 'All',
        'applicationCategory': 'DeveloperApplication',
        'offers': { '@type': 'Offer', 'price': '0', 'priceCurrency': 'USD' },
        'description': 'Encode special characters into safe HTML entities or decode entities back to plain text instantly in your browser.'
      },
      {
        '@type': 'FAQPage',
        'mainEntity': [
          {
            ...
            'acceptedAnswer': { '@type': 'Answer', 'text': 'Type or paste your raw text or HTML entities to convert them instantly based on your selected mode.' }
          },
          {
            '@type': 'Question',
            'name': 'Is HTML processing secure?',
            'acceptedAnswer': { '@type': 'Answer', 'text': 'Yes, 100% client-side processing ensuring total privacy and lightning-fast execution.' }
          }
        ]
      }
    ]
      ...
      <GlobalContainer maxWidth="2xl">
        <div style={{ paddingTop: 'var(--space-8)', paddingBottom: 'var(--space-16)' }}>
          <SectionHeading
            ...
            subtitle="Safely convert special characters into HTML entities or decode entities back into readable strings."
          />
          ...
          <div style={{ backgroundColor: 'rgba(255,255,255,0.02)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: '12px', padding: '24px', marginTop: 'var(--space-6)' }}>
            <div style={{ display: 'flex', gap: '8px', marginBottom: '20px' }}>
              <button
                ...
                style={{ backgroundColor: mode === 'encode' ? 'rgba(59, 130, 246, 0.25)' : 'rgba(0,0,0,0.3)', color: mode === 'encode' ? '#60a5fa' : '#94a3b8', border: '1px solid rgba(59, 130, 246, 0.3)', borderRadius: '8px', padding: '8px 20px', fontSize: '0.9rem', fontWeight: 600, cursor: 'pointer' }}
              >
                Encode
              </button>
              <button
                onClick={() => toggleMode('decode')}
                style={{ backgroundColor: mode === 'decode' ? 'rgba(59, 130, 246, 0.25)' : 'rgba(0,0,0,0.3)', color: mode === 'decode' ? '#60a5fa' : '#94a3b8', border: '1px solid rgba(59, 130, 246, 0.3)', borderRadius: '8px', padding: '8px 20px', fontSize: '0.9rem', fontWeight: 600, cursor: 'pointer' }}
              >
                Decode
              </button>
            </div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '20px' }}>
              <div>
                ...
                <textarea
                  ...
                  rows={10}
                  placeholder={mode === 'encode' ? 'Enter text with special characters...' : 'Paste encoded HTML entities...'}
          ...
          <div style={{ marginTop: '48px', backgroundColor: 'rgba(255,255,255,0.02)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: '12px', padding: '32px' }}>
            ...
            <div style={{ marginBottom: '16px' }}>
              ...
              <p style={{ color: '#94a3b8', lineHeight: 1.6 }}>Yes, VelnoxLabs HTML Encoder & Decoder is 100% free with no sign-up required.</p>
            </div>
