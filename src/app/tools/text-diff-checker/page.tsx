...
export default function TextDiffCheckerPage() {
  const [original, setOriginal] = useState('VelnoxLabs developer tools v1.0');
  const [modified, setModified] = useState('VelnoxLabs enterprise developer tools v2.0');
        ...
        'mainEntity': [
          {
            ...
            'acceptedAnswer': {
              '@type': 'Answer',
              'text': 'Paste your original and modified text blocks into the respective boxes to inspect changes instantly.'
            }
          },
          {
            '@type': 'Question',
            ...
            'acceptedAnswer': {
              '@type': 'Answer',
              'text': 'Yes, 100% client-side processing ensuring your data never leaves your device.'
            }
          }
        ]
      }
          ...
          <div style={{ backgroundColor: 'rgba(255,255,255,0.02)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: '12px', padding: '24px', marginTop: 'var(--space-6)' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '20px' }}>
              <div>
                ...
                <textarea value={original || ''} onChange={(e) => setOriginal(e.target.value)} rows={10} placeholder="Enter your input here..." style={{ width: '100%', backgroundColor: 'rgba(0,0,0,0.3)', border: '1px solid rgba(255,255,255,0.1)', borderRadius: '8px', color: '#fff', padding: '12px', fontFamily: 'monospace', fontSize: '0.85rem', outline: 'none' }} />
              </div>
              <div>
...
<div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '8px' }}>
                ...
                <textarea value={modified || ''} readOnly rows={10} placeholder="Output will appear here..." style={{ width: '100%', backgroundColor: 'rgba(0,0,0,0.3)', border: '1px solid rgba(255,255,255,0.1)', borderRadius: '8px', color: '#34d399', padding: '12px', fontFamily: 'monospace', fontSize: '0.85rem', outline: 'none' }} />
              </div>
            </div>
          </div>
