...
export default function JsonYamlPage() {
  ...
  const handleConvert = (val: string, currentMode: string) => {
    setInput(val);
    setError('');
  ...
  useEffect(() => {
    if (input) {
      try { handleConvert(input, mode); } catch(e) {}
    }
  }, []);
        ...
        <div style={{ paddingTop: 'var(--space-8)', paddingBottom: 'var(--space-16)' }}>
          ...
          <div style={{ marginTop: '48px', backgroundColor: 'rgba(255,255,255,0.02)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: '12px', padding: '32px' }}>
            ...
            <ul style={{ color: '#94a3b8', lineHeight: 1.9, paddingLeft: '20px', marginBottom: '24px' }}>
              <li>Paste your JSON or YAML content into the input text area.</li>
              <li>Click the <strong style={{ color: '#60a5fa' }}>JSON to YAML</strong> or <strong style={{ color: '#60a5fa' }}>YAML to JSON</strong> toggle to select the conversion direction.</li>
              <li>The converted output appears instantly in the output panel on the right.</li>
            ...
            <div style={{ marginBottom: '16px' }}>
              ...
              <p style={{ color: '#94a3b8', lineHeight: 1.6 }}>Absolutely. All conversions happen entirely in your browser using client-side JavaScript. Your data never leaves your device and is never sent to any server.</p>
            </div>

            <div style={{ marginBottom: '16px' }}>
              <h4 style={{ fontSize: '1rem', fontWeight: 600, color: '#60a5fa', marginBottom: '6px' }}>Does it support nested JSON objects and arrays?</h4>
              <p style={{ color: '#94a3b8', lineHeight: 1.6 }}>Yes, the converter handles deeply nested objects, arrays, booleans, numbers, and strings. It preserves the full structure during conversion.</p>
            </div>
          </div>
