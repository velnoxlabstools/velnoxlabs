...
export default function Home() {
  const toolsList = [
    ...
    { name: 'Random Number Generator', path: '/tools/random-number-generator', desc: 'Generate random numbers in any range with unique-only and sorting options.', cat: 'Utility' },
    { name: 'Compound Interest Calculator', path: '/tools/compound-interest-calculator', desc: 'Calculate compound growth with monthly contributions and yearly breakdown.', cat: 'Finance' },
      ...
      <div style={{ paddingTop: 'var(--space-12)', paddingBottom: 'var(--space-16)' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(180px, 1fr))', gap: '16px', marginBottom: 'var(--space-16)', backgroundColor: 'rgba(255, 255, 255, 0.02)', border: '1px solid rgba(255, 255, 255, 0.08)', borderRadius: '12px', padding: '24px', textAlign: 'center' }}>
          ...
          <div>
            ...
            <div style={{ color: '#ffffff', fontSize: '2rem', fontWeight: 700 }}>10</div>
          </div>
          <div>
